...
interface StrategyPromptAreaProps {
  graph: Graph | null;
...
export default function StrategyPromptArea({ 
  graph, 
  selectedNodeId,
  onWebSearch,
  isSearching = false
}: StrategyPromptAreaProps) {
...
`.trim();
  ...
  useEffect(() => {
    ...
    if (expandedSections.graphSummary) {
      contextSections.push(graphSummary);
    }
          ...
          <div className="p-4 space-y-3 bg-gray-50 border-b">
            ...
            >
              ...
              <CollapsibleContent className="p-3 text-sm font-mono bg-gray-50 border-t">
                {graph ? graphSummary : "No graph data available"}
              </CollapsibleContent>
            </Collapsible>
            ...
            <CardContent>
              {graph ? (
                ...
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p className="text-sm mt-2">Generate a graph first to explore the data</p>
                </div>
              )}
            </CardContent>
          </Card>
